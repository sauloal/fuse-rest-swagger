#!/usr/bin/env python
# source: https://raw.githubusercontent.com/kevinquinnyo/rest-fs/master/rest.py
# Latest commit f75ef55  on 6 Aug 2017
#
# python rest.py https://dog.ceo/api /tmp/test
# cd /tmp/test
# ls breeds/list
#
#The API I am using above for testing is https://dog.ceo/dog-api/.
